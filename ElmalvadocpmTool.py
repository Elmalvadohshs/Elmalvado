    ...
    while True:
        ...
        while True:
            ...
            menu_price_list = [
                ...
                ("{23}: Unlock Equipaments F          ", "2K"),
                ("{24}: Change Race Wins              ", "2K"),
                ("{25}: Change Race Loses             ", "2K"),
                ("{26}: Clone Account                 ", "7K"),
                ("{27}: Custom HP                     ", "2K"),
                ("{28}: Custom Angle                  ", "2K"),
                ("{29}: Custom Tire Burner            ", "2K"),
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ ELMALVADO TOOL ]==============='))
